...
public class DeleteLead {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//*[@name='id']")).sendKeys(leadId);
		Thread.sleep(5000);
		driver.findElement(By.xpath("//button[text()='Find Leads']")).click();
		Thread.sleep(2000);

		String text = driver.findElement(By.xpath("//*[text()='No records to display']")).getText();
